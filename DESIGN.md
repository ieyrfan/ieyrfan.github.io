# IRFAN / PROFESSIONAL MOTION SYSTEM

## Design position

The portfolio presents Muhammad Irfan bin Rizal as a cloud computing student with credible technical work. The interface uses a compact editorial system: white and cool-grey surfaces, dark navy structure, one purposeful blue accent, direct copy and a controlled spacing scale.
...
- **Palette:** paper `#f4f7fb`, white `#ffffff`, ink `#101828`, navy `#0c1728`, blue `#1457d9` and green only for availability.
...
- **Motion:** staggered hero entrances, blur-to-sharp section reveals, animated section rules, card lift and directional link feedback, a short route progress wipe, slow cloud depth and one scroll-linked cloud entry.
...
Desktop layouts use an 1180 px maximum reading width. Tablet layouts reduce navigation density and collapse multi-column content where needed. At 760 px and below, the navigation becomes a full-width menu, all editorial sections use a single-column flow and dense interfaces become stacked touch targets.
...
- `portfolio-v11.css` — complete Professional Motion visual layer and responsive rules
